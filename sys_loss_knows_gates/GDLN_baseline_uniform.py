...
if __name__ == "__main__":
  ...
  plt.savefig('train_norms/'+str(run_idx)+'_buniform.pdf')
  plt.close()
  ...
  plt.grid()
  plt.legend(loc='upper left')
  plt.savefig('test_norms/'+str(run_idx)+'_buniform.pdf')
  plt.close()
  ...
  np.savetxt('n_runs/'+str(run_idx)+'_buniform_train_module_enorms.txt', chosen_enorms)
  ...
  np.savetxt('n_runs/'+str(run_idx)+'_buniform_test_module_enorms.txt', test_chosen_enorms)
