...
if __name__ == "__main__":
  ...
  for epoch in range(num_epochs):
      ...
      print("$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$        "+str(i)+"       $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$")
      key, module_key, er_key, gating_key, stats_key = random.split(key, num=5)
      modules_params = weight_step(modules_params, modules_ranges, gate_params, (X_seen,Y_seen), rand_prob, module_key)
      er_params = er_step(er_params, gate_params, modules_params, modules_ranges, (X_seen,Y_seen), rand_prob, er_key)
  ...
  plt.savefig('train_norms/'+str(run_idx)+'_bhabit.pdf')
  plt.close()
  ...
  plt.grid()
  plt.legend(loc='upper left')
  plt.savefig('test_norms/'+str(run_idx)+'_bhabit.pdf')
  plt.close()
  ...
  np.savetxt('n_runs/'+str(run_idx)+'_bhabit_train_module_enorms.txt', chosen_enorms)
  ...
  np.savetxt('n_runs/'+str(run_idx)+'_bhabit_test_module_enorms.txt', test_chosen_enorms)
