...
if __name__ == "__main__":
  ...
  for epoch in range(num_epochs):
      ...
      print("$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$        "+str(i)+"       $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$")
      key, forward_key, er_key, gating_key, stats_key = random.split(key, num=5)
      forward_params = weight_step(forward_params, gate_params, (X_seen,Y_seen), rand_prob, forward_key)
  ...
  plt.colorbar()
  plt.savefig('end_gates/'+str(run_idx)+'_bhabit.pdf',dpi=400)
  plt.close()
  ...
  plt.grid()
  plt.savefig('losses/'+str(run_idx)+'_bhabit.pdf')
  plt.close()
  ...
  plt.legend(loc='upper right')
  plt.grid()
  plt.savefig('sys_losses/'+str(run_idx)+'_bhabit.pdf')
  plt.close()
  ...
  plt.legend(loc='upper right')
  plt.grid()
  plt.savefig('non_losses/'+str(run_idx)+'_bhabit.pdf')
  plt.close()

  np.savetxt('n_runs/'+str(run_idx)+'_bhabit_train_losses.txt', losses)
  np.savetxt('n_runs/'+str(run_idx)+'_bhabit_sys_train_losses.txt', sys_losses)
  np.savetxt('n_runs/'+str(run_idx)+'_bhabit_non_train_losses.txt', non_losses)
  np.savetxt('n_runs/'+str(run_idx)+'_bhabit_test_losses.txt', test_losses)
  np.savetxt('n_runs/'+str(run_idx)+'_bhabit_sys_test_losses.txt', sys_test_losses)
  np.savetxt('n_runs/'+str(run_idx)+'_bhabit_non_test_losses.txt', non_test_losses)
