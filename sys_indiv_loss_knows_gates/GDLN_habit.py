...
if __name__ == "__main__":
  ...
  plt.legend(loc='upper right')
  plt.grid()
  plt.savefig('sys_losses/'+str(run_idx)+'_habit.pdf')
  plt.close()
  ...
  plt.legend(loc='upper right')
  plt.grid()
  plt.savefig('non_losses/'+str(run_idx)+'_habit.pdf')
  plt.close()

  np.savetxt('n_runs/'+str(run_idx)+'_habit_train_losses.txt', losses)
  np.savetxt('n_runs/'+str(run_idx)+'_habit_sys_train_losses.txt', sys_losses)
  np.savetxt('n_runs/'+str(run_idx)+'_habit_non_train_losses.txt', non_losses)
  np.savetxt('n_runs/'+str(run_idx)+'_habit_test_losses.txt', test_losses)
  np.savetxt('n_runs/'+str(run_idx)+'_habit_sys_test_losses.txt', sys_test_losses)
  np.savetxt('n_runs/'+str(run_idx)+'_habit_non_test_losses.txt', non_test_losses)
