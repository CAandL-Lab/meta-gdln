...
if __name__ == "__main__":
  ...
  plt.colorbar()
  plt.savefig('end_gates/'+str(run_idx)+'_buniform.pdf',dpi=400)
  plt.close()
  ...
  plt.grid()
  plt.savefig('losses/'+str(run_idx)+'_buniform.pdf')
  plt.close()
  ...
  plt.legend(loc='upper right')
  plt.grid()
  plt.savefig('sys_losses/'+str(run_idx)+'_buniform.pdf')
  plt.close()
  ...
  plt.legend(loc='upper right')
  plt.grid()
  plt.savefig('non_losses/'+str(run_idx)+'_buniform.pdf')
  plt.close()

  np.savetxt('n_runs/'+str(run_idx)+'_buniform_train_losses.txt', losses)
  np.savetxt('n_runs/'+str(run_idx)+'_buniform_sys_train_losses.txt', sys_losses)
  np.savetxt('n_runs/'+str(run_idx)+'_buniform_non_train_losses.txt', non_losses)
  np.savetxt('n_runs/'+str(run_idx)+'_buniform_test_losses.txt', test_losses)
  np.savetxt('n_runs/'+str(run_idx)+'_buniform_sys_test_losses.txt', sys_test_losses)
  np.savetxt('n_runs/'+str(run_idx)+'_buniform_non_test_losses.txt', non_test_losses)
